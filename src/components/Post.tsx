...
const viralComments: Omit<Comment, 'id' | 'timestamp' | 'likes' | 'retweets' | 'replies'>[] = [
  ...
  { author: 'Newsletter Daily', handle: '@newsletterdaily', content: 'Featured this in our newsletter! 📧', verified: true, baseLikes: 156, baseRetweets: 67, baseReplies: 12 },
  ...
  { author: 'Product Hunter', handle: '@producthunter', content: 'This needs to be featured! 🚀', verified: true, baseLikes: 234, baseRetweets: 89, baseReplies: 18 },
  { author: 'Venture Capital', handle: '@venturecap', content: 'Solid execution. Would love to see more.', verified: true, baseLikes: 312, baseRetweets: 124, baseReplies: 23 },
  { author: 'Tech News Daily', handle: '@technewsdaily', content: 'Covering this in our next article! 📰', verified: true, baseLikes: 445, baseRetweets: 189, baseReplies: 34 },
  ...
  { author: 'Tech Beat', handle: '@techbeat', content: 'Breaking: This post just went mega viral! 📊', verified: true, baseLikes: 678, baseRetweets: 267, baseReplies: 45 },
